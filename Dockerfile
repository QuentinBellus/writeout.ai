...
RUN sed -i 's/upload_max_filesize = .*/upload_max_filesize = 40M/g' /etc/php/8.1/cli/php.ini
RUN sed -i 's/post_max_size = .*/post_max_size = 40M/g' /etc/php/8.1/cli/php.ini
